...
def projection(args, path_img1, criterion, G, latent_mean, latent_std):
    ...
    for i in pbar:
        ...
        if num_loss < min_loss:
            ...
            # Save the image
            output_dir = 'images/example/mdf_stepV1_02_JPG3/'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--step", type=int, default=50000) # cal W

    # parser.add_argument("--batch_size", type=int, default=8)
    parser.add_argument("--n_mean_latent", type=int, default=10)
    ...
    dst_img = 'images/example/mdf_v1_morph02.png'
