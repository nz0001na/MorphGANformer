...
def projection(args, path_img1, WingLoss, G, latent_mean, latent_std, detector, predictor):
...
if __name__ == "__main__":
    ...
    output_dir = 'images/2_frgc_data/frgc_exp_1024/wing_loss/'
    if os.path.exists(output_dir) is False:
        os.makedirs(output_dir)
    ...
    w1 = projection(args, path_img1, WingLoss, G, latent_mean, latent_std, detector, predictor)