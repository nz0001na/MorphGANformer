...
split_file = ro + '5_morphing_fingerprint_train_test_split_all/'
...
for db in dbs:
    ...
    # disp.plot()
    # plt.show()
    # plt.savefig(fig_path + 'all_train_test1.jpg')
    # plt.close()
    # print(mt)
    #
    # # normalized
    ...
    # disp.plot()
    # plt.show()
    # plt.savefig(fig_path + 'all_train_test2.jpg')
    # plt.close()
    # print(mt2)
