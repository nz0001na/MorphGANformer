...
def projection(args, path_img1, percept, MSE, G, latent_mean, latent_std):
...
if __name__ == "__main__":
    ...
    out_dir = 'images/2_frgc_data/frgc_exp_1024/vgg_mse_perct'
    ...
    w1 = projection(args, path_img1, percept, MSE, G, latent_mean, latent_std)
