...
# get latent code
def projection(args, path_img1, percept, WingLoss, G, latent_mean, latent_std, detector, predictor):
    ...
    for i in pbar:
        ...
        # all_loss = args.lamda * p_loss + (1 - args.lamda) * w_loss
        all_loss = p_loss + args.lamda * w_loss
        optimizer.zero_grad()
        # p_loss.backward()
        # mse_loss.backward()
        all_loss.backward()
...
if __name__ == "__main__":
    ...
    output_dir = 'images/2_frgc_data/frgc_exp_1024/wing_loss_adaptive_squzee_01/'
    if os.path.exists(output_dir) is False:
        os.makedirs(output_dir)
    ...
    w1 = projection(args, path_img1, percept, WingLoss, G, latent_mean, latent_std, detector, predictor)
